...
public class AccountCenterController {
    ...
    public ResultUtil<String> addBindingCSI(AddBindingCSIReq addBindingCSIReq) {
        ...
        return row > 0 ? resultUtil.AesJSONSuccess("绑定成功","") : resultUtil.AesFAILError("绑定失败");
    }
    ...
    public ResultUtil<String> changeNewMobile(ChangeMobileReq changeMobileReq) {
        ...
        int row = accountService.changeMobile(ContextUtil.getUserId().toString(), changeMobileReq.getMobile());
