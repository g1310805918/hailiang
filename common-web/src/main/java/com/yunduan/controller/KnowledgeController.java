...
public class KnowledgeController {
    ...
    @ApiOperation(httpMethod = "GET", value = "工单详情添加文档")
    @RequestMapping(value = "/add-knowledge", method = RequestMethod.GET)
    public ResultUtil<List<KnowledgeDocument>> addKnowledge(AddKnowledgeReq addKnowledgeReq) {
        addKnowledgeReq = AESUtil.decryptToObj(addKnowledgeReq.getData(), AddKnowledgeReq.class);
        //文档结果
        List<KnowledgeDocument> knowledgeDocuments = knowledgeDocumentService.searchDocList(addKnowledgeReq);
        return resultUtil.AesJSONSuccess("SUCCESS", knowledgeDocuments);
    }
