...
public interface CommonConstant {
     ...
     * 用户默认头像
     */
    String USER_DEFAULT_AVATAR = "http://www.ningbo.cn/avatar.jpg";
     ...
     * 限流标识
     */
    String LIMIT_ALL = "HIGHSET_LIMIT_ALL";
     ...
     * 短信验证码key前缀
     */
    String PRE_SMS = "HIGHSET_PRE_SMS:";

    /**
     * 邮件验证码key前缀
     */
    String PRE_EMAIL = "HIGHSET_PRE_EMAIL:";
