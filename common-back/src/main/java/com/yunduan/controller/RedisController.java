...
import com.yunduan.vo.back.RedisInfo;
import com.yunduan.vo.back.RedisVo;
...
public class RedisController {
    ...
    private static final transient Logger log = LoggerFactory.getLogger(RedisController.class);
