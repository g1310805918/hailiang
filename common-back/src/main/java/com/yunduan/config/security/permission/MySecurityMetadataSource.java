package com.yunduan.config.security.permission;
...
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadResourceDefine() {
        ...
        ConfigAttribute cfg;
        // 获取启用的权限操作请求
        List<Permission> permissions = permissionService.list(new QueryWrapper<Permission>().eq("type", CommonConstant.PERMISSION_OPERATION).eq("status", CommonConstant.STATUS_NORMAL).orderByDesc("sort_order"));
